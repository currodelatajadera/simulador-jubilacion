...
# ============================================
#   GENERACIÓN Y DESCARGA DEL INFORME SRG
# ============================================

st.markdown('<div class="srg-title">Generar informe SRG</div>', unsafe_allow_html=True)
st.markdown('<div class="srg-box">', unsafe_allow_html=True)

col_gen, col_desc = st.columns(2)

with col_gen:
    st.markdown("### Tipo de informe")
    ...
    generar = st.button("Generar informe ahora", use_container_width=True)
...
st.markdown('</div>', unsafe_allow_html=True)  # cierre caja azul

# ============================================
#   SOLO MOSTRAR INFORME SI SE PULSA EL BOTÓN
# ============================================
...
if generar:
    ...
    st.markdown('<div class="srg-title">Descargar informe SRG</div>', unsafe_allow_html=True)
    st.markdown('<div class="srg-box">', unsafe_allow_html=True)
    ...
    # ============================================
    #   VISTA PREVIA DEL INFORME (SOLO TRAS BOTÓN)
    # ============================================

    st.markdown('<div class="srg-title">Vista previa del informe</div>', unsafe_allow_html=True)
    st.markdown('<div class="srg-box">', unsafe_allow_html=True)

    st.components.v1.html(html_informe, height=1200, scrolling=True)
